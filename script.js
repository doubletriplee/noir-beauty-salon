...
document.querySelector('.request form')?.addEventListener('submit', (event) => { event.preventDefault(); const btn = event.currentTarget.querySelector('button'); btn.textContent = 'Заявка принята ✓'; btn.disabled = true; });
